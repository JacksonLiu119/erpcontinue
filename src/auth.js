...
const routeCapability = [
  ...
  [/^\/sales-workflow\/maintenance\/orders(?:\/|$)/, 'sales-maintenance'],
  [/^\/sales-workflow\/maintenance\/queries\/(?:customer|order|tree|customer-transactions)(?:\/|$)/, 'sales-readonly'],
  [/^\/sales-workflow\/maintenance\/events(?:\/|$)/, 'sales-readonly'],
  ...
  [/^\/sales-workflow\/customer-controls(?:\/|$)/, 'source-customers'],
  ...
  [/^\/accounting\/(trial-balance|account-balances|ledger-details|reconciliation|source-financial-preview|financial-statements)/, 'accounting-general-ledger'],
